...
A. Download & Setup	sh gemma_setup.sh	Scarica i dataset Amazon Reviews, dati NLTK e T5-Gemma.	—
B. Pre-calcolo	python precompute_embeddings.py	Genera embedding semantici per utenti e articoli.	GPU
C. Consolidamento	python consolidate_embeddings.py	Unisce i batch di embedding in file .npy.	—
